...
public class EmpAddViewActivity extends AppCompatActivity {
	...
	private DatabaseReference dbb = _firebase.getReference("db/manager_info");
	private ChildEventListener _dbb_child_listener;
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.emp_add_view);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				test=test.split("@")[0];
				db.child(test).updateChildren(map);
				map.clear();
				fauth.createUserWithEmailAndPassword(edittext1.getText().toString(), edittext2.getText().toString()).addOnCompleteListener(EmpAddViewActivity.this, _fauth_create_user_listener);
				b.setClass(getApplicationContext(), TasksformanagerActivity.class);
		...
		button2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				test = edittext1.getText().toString();
				test=test.split("@")[0];
				dbb.child(test).updateChildren(map);
				map.clear();
				fauth.createUserWithEmailAndPassword(edittext1.getText().toString(), edittext2.getText().toString()).addOnCompleteListener(EmpAddViewActivity.this, _fauth_create_user_listener);
				b.setClass(getApplicationContext(), TasksformanagerActivity.class);
				b.putExtra("email", getIntent().getStringExtra("email"));
		...
		_dbb_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
				final String _childKey = _param1.getKey();
		...
		dbb.addChildEventListener(_dbb_child_listener);
